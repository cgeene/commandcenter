...
function signalTitle(kind: string, payload: Record<string, unknown>): string {
  const titles: Record<string, string> = {
    ...
    "review.rework_budget_skipped": "Rework held (budget)",
    ...
    "reviewer.retired": "Reviewer retired",
    "review.reviewer_replaced": "Replacement reviewer started",
    "review.replacement_declined": "Replacement declined",
    ...
    "main.spawn_abandoned": "Main agent never started",
    "agent.spawn_failed": "Agent failed to start",
